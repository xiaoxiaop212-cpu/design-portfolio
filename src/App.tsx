...
export const projects = [
  {
    ...
    image: `import.meta.env.BASE_URL + "images/suao-1.png",
    tags: ["景观设计", "景观", "商业景观"],
    details: {
      location: "江苏常州",
      type: "商业办公"
...
项目整体立足于生态协同与创新街坊的融合发展，回应高定位、大格局、创未来的区域愿景，构建面向未来的城市创智空间。`,
    renderings: [
      `import.meta.env.BASE_URL + "images/suao-r1.png",
      `import.meta.env.BASE_URL + "images/suao-r2.png",
      `import.meta.env.BASE_URL + "images/suao-r3.png",
      `import.meta.env.BASE_URL + "images/suao-r4.png"
    ]
  },

  {
    ...
    image: `import.meta.env.BASE_URL + "images/yuelai-main.png",
    tags: ["商业综合体", "多元空间", "景观"],
    details: {
      location: "河南平顶山",
      type: "商业综合体"
...
竞品项目中广场硬质过多、可停留节点缺失、室内外联动不足等问题，强化了亲水体验、休息节点和街区式的空间串联。整体上，景观不是商业的附属，而是与商业功能并行的公共载体，旨在实现繁忙城市中的一片宁静与自然体验的融合。`,
    renderings: [
      `import.meta.env.BASE_URL + "images/yuelai-r1.png",
      `import.meta.env.BASE_URL + "images/yuelai-r2.png",
      `import.meta.env.BASE_URL + "images/yuelai-r3.png",
      `import.meta.env.BASE_URL + "images/yuelai-r4.png"
    ]
  },
  {
    id: 4,
    ...
    image: `import.meta.env.BASE_URL + "images/wuyue-main.png",
    tags: ["住宅景观", "生态", "总体规划"],
    details: {
      location: "山东东营",
      type: "住宅景观"
...
整体依托五进院落式空间序列，在礼制与自然之间形成"一半烟火、一半清欢"的栖居格局，兼顾日常生活的便利性与精神层面的诗意体验。`,
    renderings: [
      `import.meta.env.BASE_URL + "images/wuyue-r1.png",
      `import.meta.env.BASE_URL + "images/wuyue-r2.png",
      `import.meta.env.BASE_URL + "images/wuyue-r3.png",
      `import.meta.env.BASE_URL + "images/wuyue-r4.png"
    ]
  },
  {
    id: 5,
    ...
    image: `import.meta.env.BASE_URL + "images/tianle-main.jpg",
    tags: ["城市", "硬质景观", "活动"],
    details: {
      location: "安徽合肥",
      type: "社区更新"
...
设计中特别关注老年居民的使用需求，设置了无障碍通道、休憩廊架以及康体健身区域。同时，通过社区文化墙和景观小品，讲述社区历史，增强居民归属感。`,
    renderings: [
      `import.meta.env.BASE_URL + "images/tianle-r1.jpg",
      `import.meta.env.BASE_URL + "images/tianle-r2.jpg",
      `import.meta.env.BASE_URL + "images/tianle-r3.jpg"
    ]
  }
];
